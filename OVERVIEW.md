...
This file contains all the salient details about this project, is kept up to date and is managed by Claude with prompting by the coder. It avoids the time consuming priming task when new Claude sessions are started.
